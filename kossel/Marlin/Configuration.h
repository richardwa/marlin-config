...
#define STRING_CONFIG_H_AUTHOR "Richard Wang" // Who made the changes.
...
#define DELTA
  ...
  // NOTE NB all values for DELTA_* values MUST be floating point, so always have a decimal point in them
    ...
    // #define MIN_PROBE_EDGE DELTA_PRINTABLE_RADIUS - (MIN_PROBE_EDGE)  // (mm)
  ...
  #define DELTA_HEIGHT 279.88             // (mm) Get this value from G33 auto calibrate
  ...
  #define DELTA_TOWER_ANGLE_TRIM { -0.16, -0.25, 0.41 } // Get these values from G33 auto calibrate
...
//#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
  ...
  #define MAX_FEEDRATE_EDIT_VALUES    { 100, 100, 100, 25 }
#endif
...
//#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
  ...
  #define MAX_ACCEL_EDIT_VALUES        { 2000, 2000, 2000, 2000 }
#endif
